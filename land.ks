...
print "dtBrake:  " + dtBrake at (5, 20).
print "dtGround: " + dtGround at (5, 21).
    if final {
print "Final    " at (0,15).
...
print "Pre-Brake" at (0, 15).
print "altF: " + rf:y + " - " + geoF:position:y + " = " + altF at (5, 16).
      if altF < -100 {
