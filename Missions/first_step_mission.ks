...
{
  output("Loading First Step mission", true).

  global first_step_mission is lex(
    "sequence", list(
      "preflight", preflight@,
      "launch", launch@,
      "ascent", ascent@,
  ...
  function preflight {
    ...
    output("Launch parameters: " + first_step_mission["target_heading"] + ":" + first_step_mission["target_altitude"] + ":" + first_step_mission["final_altitude"], true).
    if launcher["launch"](first_step_mission["target_heading"], first_step_mission["target_altitude"], first_step_mission["final_altitude"]) {
